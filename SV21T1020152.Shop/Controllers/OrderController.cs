...
using SV21T1020152.BusinessLayers;
using SV21T1020152.DomainModels;
using SV21T1020152.Shop.Models;

namespace SV21T1020152.Shop.Controllers
{
    [Authorize]
    public class OrderController : Controller
    {
        ...
        public IActionResult Init(string deliveryProvince = "", string deliveryAddress = "")
        {
            ...
            int orderID = SaleDataService.InitOrder(1, customerID, deliveryProvince, deliveryAddress, orderDetails);
            ClearCart();
            return Json(orderID);
